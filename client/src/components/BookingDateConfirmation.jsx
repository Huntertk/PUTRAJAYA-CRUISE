  ...
  return (
    <section className='bookingDateConfirmationMainContainer'>
        <div className="bookingDateWrapper">
            ...
            {
                selectedDate && type === 'bookTypeTwo' && <PreferenceTour selectedDate={selectedDate} data={prefrenceOpt}  /> 
            }

            {
                 selectedDate && type === 'bookTypeOne' && pref && isPaxModal === false && <TimeSlotSelection selectedDate={selectedDate} />
            }
            <div className="selectedDate">
                {
                    ...
                    <div className='prefrenceAndDateContainer'>
                        <p>{
                            type === 'bookTypeOne' && pref && timeSlot.timeSlot  ?  pref  : type === 'bookTypeTwo' && pref ?  pref : <></> 
                        }</p>
                    <p>You selected {format(selectedDate, 'PPP')}.</p>
                    </div>
                    {
                        type === 'bookTypeOne' && pref && timeSlot.timeSlot ? <button onClick={() => {
                            ...
                            dispatch(setBookingDate({selectedBookingDate:format(selectedDate, 'PPP'), selectedDay: selectedDate.toString()}))
                            dispatch(selectTimeSlot({selectedTimeSlot:{name:"",timeSlot:""}}))
                            dispatch(openPaxModel())
                            setCalenderOpen(false)
                        }}>Next</button>  : <></>
                    }
